...
const DeleteCustomer = (id, callbackref) => {
  ...
  API.XoaHinhThucThanhToan(params).then(
    res => {
...
const ThongTinHTTT = props => {
  ...
  const onClickInactive = React.useCallback(() => {
    return Alert.alert(
      I18n.t('common.notice'),
      I18n.t('DanhSachHinhThucThanhToan.banCoMuonXoaHinhThucThanhToan'),
      [
        {
        ...
        },
        {
          ...
          onPress: () =>
            DeleteCustomer(detailCustomer.maHinhthucttId, props.callbackref),
        },
      ],
      {cancelable: false},
    );
  ...
  return (
    <SafeAreaView style={AppStyles.styleSafeArea}>
      ...
      <AppHeader
        ...
        title={I18n.t('DanhSachHinhThucThanhToan.thongTinHinhThucThanhToan')}
        RightText={I18n.t('ScreenKhachHang.sua')}
        onPressRight={() =>
          Actions.themSuaHinhThucThanhToan({
            thongTinHTTT: detailCustomer,
      ...
      <ScrollView
        ...
        <View style={{flex: 1, paddingHorizontal: 10}}>
          <InfoLabel
            Icon={CodeScan}
            LeftText={I18n.t('DanhSachHinhThucThanhToan.maHinhThucThanhToan')}
            RightText={detailCustomer.maHinhthuctt}
          />
          <View style={styles.line} />
          <InfoLabel
            Icon={HinhThucThanhToan}
            LeftText={I18n.t('DanhSachHinhThucThanhToan.tenHinhThucThanhToan')}
            RightText={detailCustomer.tenHinhthuctt}
          />
          <View style={styles.line} />
        </View>
